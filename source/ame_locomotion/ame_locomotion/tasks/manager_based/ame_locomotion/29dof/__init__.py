...
gym.register(
    id="AME-G1-29DOF-DTC-PlannerV2-LIPM-PaperMLP-TerrainWindow-NoAliveVelStd05-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.velocity_env_cfg_29dof:G1RoughEnvCfg_DTC_PlannerV2_LIPM_PaperMLP_TERRAIN_WINDOW_NOALIVE_VELSTD05",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.ame_rsl_rl_ppo_cfg:G1TerrainMlpPPORunnerCfg",
    },
)
