...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if agent_cfg.resume or getattr(agent_cfg.algorithm, "class_name", "PPO") == "Distillation":
    ...
    # Adapter: Isaac Lab 2.3.0 returns (Tensor, extras); the bundled rsl_rl
    # runner expects a TensorDict with named observation groups.
    env = IsaacLabTensorDictAdapter(env)

    # create runner from rsl-rl (Isaac Lab 2.3.0 has no class_name on the runner cfg)
